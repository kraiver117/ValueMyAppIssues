...
const email_scio="jagutierrez@sciodev.com"

const service_id = "gmail";
//const template_id = "template_Q8xb3sx7";//Formato de la api Mario

const template_id="template_cgGPtMP8"; //Angel
//const template_id_scio = "email_notification_scio";//Email de notificaciones de Scio Mario

const template_id_scio = "example_email";//Email de notificaciones de Scio Angel


//const user_id = 'user_miSxUoip92knRTffaAMa6'; //Mario
const user_id = "user_oiNgU3nifYwSUYXHE262v"; //Angel
